...
int main(int argc, char *argv[]){
  ...
  NamedFunc base_func = "pass && met/met_calo<5 && njets>=4 && njets<=5 && nbt>=2 && nvleps==0&&ntks==0&&!low_dphi&&met>150&&hig_dm<40&&weight<11.1";
  ...
  if(do_hig){
    cuts = "nbt==2&&nbm==2&&met>200&&hig_drmax<2.2";
    pm.Push<Hist1D>(Axis(25, 0., 250., "hig_am", "#LTm#GT [GeV]", {100., 140.}),cuts, procs_hig, plt_norm).Tag("hig");
    cuts = "nbt>=2&&nbm==3&&nbl==3&&met>200&&hig_drmax<2.2";
    pm.Push<Hist1D>(Axis(25, 0., 250., "hig_am", "#LTm#GT [GeV]", {100., 140.}),cuts, procs_hig, plt_norm).Tag("hig");
    cuts = "nbt>=2&&nbm>=3&&nbl>=4&&met>200&&hig_drmax<2.2";
    pm.Push<Hist1D>(Axis(25, 0., 250., "hig_am", "#LTm#GT [GeV]", {100., 140.}),cuts, procs_hig, plt_norm).Tag("hig");
