...
int main(int argc, char *argv[]){
  ...
  if(Contains(prs, "TChiHH")) model = "TChiHH";
  ...
  // QCD scales don't seem properly stored in Bear babies
  ...
  if (model!="TChiHH") {
    ...
    baseline = "higd_drmax<2.2&&ntks==0&&njets>=4&&njets<=5&&!low_dphi&&nvleps==0&&pass_ra2_badmu&&met/met_calo<5";
    ...
    v_bins.push_back(bindef("sbd_2b_met0", cut2b+"&&"+cutsbd+"&& met>150&&met<=200"));
    v_bins.push_back(bindef("hig_2b_met0", cut2b+"&&"+cuthig+"&& met>150&&met<=200"));
    v_bins.push_back(bindef("sbd_3b_met0", cut3b+"&&"+cutsbd+"&& met>150&&met<=200"));
    v_bins.push_back(bindef("hig_3b_met0", cut3b+"&&"+cuthig+"&& met>150&&met<=200"));
    v_bins.push_back(bindef("sbd_4b_met0", cut4b+"&&"+cutsbd+"&& met>150&&met<=200"));
    v_bins.push_back(bindef("hig_4b_met0", cut4b+"&&"+cuthig+"&& met>150&&met<=200"));

    v_bins.push_back(bindef("sbd_2b_met1", cut2b+"&&"+cutsbd+"&& met>200&&met<=300"));
    v_bins.push_back(bindef("hig_2b_met1", cut2b+"&&"+cuthig+"&& met>200&&met<=300"));
    v_bins.push_back(bindef("sbd_3b_met1", cut3b+"&&"+cutsbd+"&& met>200&&met<=300"));
    v_bins.push_back(bindef("hig_3b_met1", cut3b+"&&"+cuthig+"&& met>200&&met<=300"));
    v_bins.push_back(bindef("sbd_4b_met1", cut4b+"&&"+cutsbd+"&& met>200&&met<=300"));
    v_bins.push_back(bindef("hig_4b_met1", cut4b+"&&"+cuthig+"&& met>200&&met<=300"));

    v_bins.push_back(bindef("sbd_2b_met2", cut2b+"&&"+cutsbd+"&& met>300&&met<=450"));
    v_bins.push_back(bindef("hig_2b_met2", cut2b+"&&"+cuthig+"&& met>300&&met<=450"));
    v_bins.push_back(bindef("sbd_3b_met2", cut3b+"&&"+cutsbd+"&& met>300&&met<=450"));
    v_bins.push_back(bindef("hig_3b_met2", cut3b+"&&"+cuthig+"&& met>300&&met<=450"));
    v_bins.push_back(bindef("sbd_4b_met2", cut4b+"&&"+cutsbd+"&& met>300&&met<=450"));
    v_bins.push_back(bindef("hig_4b_met2", cut4b+"&&"+cuthig+"&& met>300&&met<=450"));

    v_bins.push_back(bindef("sbd_2b_met3", cut2b+"&&"+cutsbd+"&& met>450"));
    v_bins.push_back(bindef("hig_2b_met3", cut2b+"&&"+cuthig+"&& met>450"));
    v_bins.push_back(bindef("sbd_3b_met3", cut3b+"&&"+cutsbd+"&& met>450"));
    v_bins.push_back(bindef("hig_3b_met3", cut3b+"&&"+cuthig+"&& met>450"));
    v_bins.push_back(bindef("sbd_4b_met3", cut4b+"&&"+cutsbd+"&& met>450"));
    v_bins.push_back(bindef("hig_4b_met3", cut4b+"&&"+cuthig+"&& met>450"));
  }
  ...
  TString outpath = outfolder+"/sys_SMS-"+TString(model)+"_"+glu_lsp+"_"+luminosity.ReplaceAll(".","p")+"ifb.txt";
  cout<<"Writing to "<<outpath<<endl;
  ofstream fsys(outpath);
  if (model!="TChiHH") fillTtbarSys(fsys);
  else fillHiggsinoSys(fsys);
...
void fillHiggsinoSys(ofstream &fsys){
    ...
    fsys << "  sbd_3b_met1    0.03"  << endl;
    fsys << "  sbd_4b_met1    0.06"  << endl;
    fsys << "  sbd_3b_met2    0.02"  << endl;
    fsys << "  sbd_4b_met2    0.04"  << endl;
    ...
    fsys << "  sbd_3b_met1    0.03"  << endl;
    fsys << "  sbd_4b_met1    0.01"  << endl;
    fsys << "  sbd_3b_met2    0.06"  << endl;
    fsys << "  sbd_4b_met2    0.04"  << endl;
    ...
    fsys << "  sbd_3b_met1    0.01"  << endl;
    fsys << "  sbd_4b_met1    0.01"  << endl;
    fsys << "  sbd_3b_met2    0.01"  << endl;
    fsys << "  sbd_4b_met2    0.01"  << endl;
    ...
    fsys << "  sbd_3b_met1    0.03"  << endl;
    fsys << "  sbd_4b_met1    0.01"  << endl;
    fsys << "  sbd_3b_met2   -0.04"  << endl;
    fsys << "  sbd_4b_met2    0.02"  << endl;
    fsys << "  sbd_3b_met3    0.06"  << endl;
    fsys << "  sbd_4b_met3    0.06"  << endl << endl;
}
