...
int main(){
  ...
  string trig_skim0l_mc = "/net/cms2/cms2r0/babymaker/babies/2016_05_31/mc/skim_qcd/";
  string trig_skim2l_mc = "/net/cms2/cms2r0/babymaker/babies/2016_05_31/mc/skim_dy_ht300/";

  Palette colors("txt/colors.txt", "default");

  auto tt1l = Proc<Baby_full>("t#bar{t} (1l)", Process::Type::background, colors("tt_1l"),
    {trig_skim1l_mc+"*_TTJets*Lept*.root", trig_skim1l_mc+"*_TTJets_HT*.root"},
    "ntruleps<=1&&stitch");
