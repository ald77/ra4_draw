...
int main(){
  ...
  //Signal Samples
  auto tbs750 = Proc<Baby_full>("m_{glu}=750$ GeV$", Process::Type::signal, colors("tt_1l"),
    {sig_folder+"*RPV_mGluino-750*"});

  auto tbs1200 = Proc<Baby_full>("m_{glu}=1200$ GeV$", Process::Type::signal, colors("tt_1l"),
    {sig_folder+"*RPV_mGluino-1200*"});
  
  auto tbs1500 = Proc<Baby_full>("m_{glu}=1500$ GeV$", Process::Type::signal, colors("tt_1l"),
