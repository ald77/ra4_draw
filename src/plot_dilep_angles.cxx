...
int main(){
  ...
  NamedFunc dphi_ll("dphi_ll", [](const Baby &b){
      double phi1, phi2;
      GetAngles(b, phi1, phi2);
  ...
  for(const auto &cat: categories){
    ...
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, dphi_ll, "#Delta#phi(l,l)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, min_dphi_lmet, "Min. #Delta#phi(l,MET)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, max_dphi_lmet, "Max. #Delta#phi(l,MET)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, min_dphi_lj, "Min. #Delta#phi(l,jet)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, max_dphi_lj, "Max. #Delta#phi(l,jet)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, min_dphi_metj, "Min. #Delta#phi(MET,jet)", cut), procs, plot_types);
    pm.Push<HistoStack>(HistoDef(tag, 31, 0., pi, max_dphi_metj, "Max. #Delta#phi(MET,jet)", cut), procs, plot_types);
  }
