...
for mass in masses:
    ...
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 1.")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.9 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.8 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.7 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.6 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.5 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.4 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.3 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.2 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0.1 --incl_nonhh")
    os.system("./run/hig/write_datacards.exe -i "+infolder+" -f "+infile+" -o out/ -l 35.9 --bf 0. --incl_nonhh")
